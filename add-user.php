          ...
          if(!empty($_POST)){
            ...
            $INSERT ="INSERT INTO mamun(user_name,user_phone,user_email,user_username,user_password)
            VALUES ('$name','$phone','$email','$username','passowrd')";
          }
                                ...
                                <div class="card mb-3">
                                  ...
                                  <div class="card-body">
                                      ...
                                      <div class="row mb-3">
                                        ...
                                        <div class="col-sm-4">
                                          <input type="file" class="form-control form_control" id="" name="picture">
                                        </div>
                                      </div>
                                  </div>
